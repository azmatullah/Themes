...
ilogic_check_colourswitch();
ilogic_initialise_colourswitcher($PAGE);

$bodyclasses = array();
$bodyclasses[] = 'ilogic-'.ilogic_get_colour();
if (!$hassidepre) {
...
if (!empty($PAGE->theme->settings->tagline)) {
    ...
    $tagline = get_string('defaulttagline', 'theme_ilogic');
}
            ...
            <div id="page-header-wrapper" class="wrapper clearfix">
                ...
                <div id="headermenu">
                    <?php if (isloggedin()) {
                        ...
                        /*echo html_writer::tag('h1', get_string('usergreeting', 'theme_ilogic', $USER->firstname));*/
                        ...
                        $loginlink = html_writer::link(new moodle_url('/login/'), get_string('loginhere', 'theme_ilogic'));
                        echo html_writer::tag('h1', get_string('welcome', 'theme_ilogic', $loginlink));
                        echo html_writer::end_tag('div');;
                    } ?>
                   ...
                   <!-- <div id="colourswitcher">
                        <ul>
                            ...
                            <li><a href="<?php echo new moodle_url($PAGE->url, array('ilogiccolour'=>'red')); ?>" class="styleswitch colour-red"><img src="<?php echo $OUTPUT->pix_url('red-theme2', 'theme'); ?>" alt="red" /></a></li>
                            <li><a href="<?php echo new moodle_url($PAGE->url, array('ilogiccolour'=>'green')); ?>" class="styleswitch colour-green"><img src="<?php echo $OUTPUT->pix_url('green-theme2', 'theme'); ?>" alt="green" /></a></li>
                            <li><a href="<?php echo new moodle_url($PAGE->url, array('ilogiccolour'=>'blue')); ?>" class="styleswitch colour-blue"><img src="<?php echo $OUTPUT->pix_url('blue-theme2', 'theme'); ?>" alt="blue" /></a></li>
                            <li><a href="<?php echo new moodle_url($PAGE->url, array('ilogiccolour'=>'orange')); ?>" class="styleswitch colour-orange"><img src="<?php echo $OUTPUT->pix_url('orange-theme2', 'theme'); ?>" alt="orange" /></a></li>
                        </ul>
                    </div>-->
